...
@retry(stop_max_attempt_number=5, wait_fixed=2000)
def TTS(text, volume=-20, out_wav='out.wav', enhanced=enable_sr, speaker_id='', speaker_path='', speaking_style=''):
    if os.path.exists(out_wav):
        return
    ...
    'speaker_path': f'{speaker_path}',
    'speaking_style': f'{speaking_style}',
    #'speaking_style': 'conversational style',
    'volume': f'{volume}',
    'output_wav': f'{out_wav}',
    }
